...
**[tendril](https://github.com/moloo4ni/tendril)** — scroll-driven wayland compositor in smithay + rust. dynamic multi-column layout with nested mode (winit). ipc: json-rpc 2.0 over unix socket + `tendrilc` cli. keyboard navigation (hjkl + arrow keys), toml config with auto hot-reload.
